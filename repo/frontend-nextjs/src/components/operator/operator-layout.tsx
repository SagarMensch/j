      ...
      <header className="sticky top-0 z-40 border-b border-border/90 bg-[rgba(248,251,254,0.92)] backdrop-blur">
        <div className="mx-auto max-w-[1580px] px-3 py-2 md:px-4">
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2">
            ...
            <div className="hidden items-center gap-2 rounded-full border border-border bg-white px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-muted md:inline-flex md:ml-auto">
